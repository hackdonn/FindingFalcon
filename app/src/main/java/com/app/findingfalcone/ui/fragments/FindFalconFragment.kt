package com.app.findingfalcone.ui.fragments
...
import com.app.findingfalcone.R
...
import com.app.findingfalcone.ui.viewModel.MainViewModel
import com.app.findingfalcone.ui.viewModel.MainViewModelFactory
...
class FindFalconFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_find_falcon, container, false)
    ...
    private fun setClickListeners() {
        findFalconButton.setOnClickListener {
            ...
            val idx1 =
                radioGroup1.indexOfChild(radioGroup1.findViewById(prevSelectedRadioButtonId[0]))
            val idx2 =
                radioGroup2.indexOfChild(radioGroup2.findViewById(prevSelectedRadioButtonId[1]))
            val idx3 =
                radioGroup3.indexOfChild(radioGroup3.findViewById(prevSelectedRadioButtonId[2]))
            val idx4 =
                radioGroup4.indexOfChild(radioGroup4.findViewById(prevSelectedRadioButtonId[3]))
            val selectedVehicles: List<String> = listOf(
                vehicleNames[idx1],
                vehicleNames[idx2],
                vehicleNames[idx3],
                vehicleNames[idx4]
    ...
    private fun showResultScreen(selectedVehicles: List<String>) {
        ...
        fragment?.let {
            val newFragment = FindFalconResultFragment.newInstance(
                totalTimeTaken,
                prevSelectedPlanetName,
                selectedVehicles
            )
